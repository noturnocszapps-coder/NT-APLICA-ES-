...
import { ExternalLink, ArrowRight, Info, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <section id="ecosystem" className="py-24 sm:py-32 relative bg-[#07090e]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-12 sm:mb-16 p-6 sm:p-10 rounded-2xl bg-[#0d1017] border border-zinc-800/90 relative overflow-hidden">
            ...
            <div className="lg:col-span-6 space-y-5 text-left">
              ...
              <div className="pt-4 flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-lg border border-zinc-800 hover:border-zinc-700 text-zinc-400 hover:text-zinc-200 text-xs font-medium uppercase tracking-wider transition-colors inline-flex items-center gap-1.5"
                >
        ...
        <div className="mb-12 sm:mb-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Partner Pro */}
          <div className="p-6 sm:p-8 rounded-2xl bg-[#0d1017] border border-zinc-800/90 flex flex-col justify-between space-y-6">
            ...
            <div className="pt-2 flex items-center justify-between gap-2 border-t border-zinc-800/60">
              ...
              {partnerProProduct.url && (
                ...
                >
                  <span>{partnerProProduct.ctaText || 'Acessar'}</span>
            ...
            <div className="pt-2 flex items-center justify-between gap-2 border-t border-zinc-800/60">
              ...
              {splitReadyProduct.url && (
                <a
                  ...
                  className="px-4 py-2 rounded-lg bg-zinc-100 hover:bg-white text-zinc-950 font-medium text-xs uppercase tracking-wider transition-colors inline-flex items-center gap-1.5"
                >
                  <span>{splitReadyProduct.ctaText || 'Acessar'}</span>
                  <ExternalLink className="w-3 h-3" />
                </a>
              )}
            </div>
        ...
        <div className="space-y-4">
          <div className="text-xs font-mono uppercase tracking-widest text-zinc-400 mb-4">
            OUTRAS INICIATIVAS DO ECOSSISTEMA
          </div>
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-[10px] font-mono text-zinc-400">
                    ...
                    {p.badge && (
                      <span className="px-2 py-0.5 rounded border border-zinc-800 text-zinc-400 bg-zinc-900">
                        {p.badge}
                      </span>
                    )}
                  </div>
                ...
                <div className="pt-3 border-t border-zinc-800/60 flex items-center justify-between text-xs">
                  ...
                  <span className="text-[10px] font-mono text-zinc-400">NT Aplicações</span>
                </div>
              </div>
            ))}
          </div>
