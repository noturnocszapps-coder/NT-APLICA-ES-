...
export const Philosophy: React.FC = () => {
  return (
    <section className="py-28 sm:py-36 relative bg-[#07090e] border-t border-zinc-800/80">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <p className="text-sm sm:text-base text-zinc-400 max-w-xl mx-auto font-normal">
          Cada projeto da NT Aplicações nasce da identificação de um problema real e evolui através de tecnologia, experiência e independência.
        </p>
